/******/ (function (modules) {
  ...
  \********************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! mongoose */ "mongoose"
        );
        /* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/ __webpack_require__.n(
          mongoose__WEBPACK_IMPORTED_MODULE_1__
        );
        /* harmony import */ var cors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! cors */ "cors"
        );
        /* harmony import */ var cors__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/ __webpack_require__.n(
          cors__WEBPACK_IMPORTED_MODULE_2__
        );
        ...
        /* harmony import */ var _handlers_errorHandler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./handlers/errorHandler */ "./src/handlers/errorHandler.js"
        );
        /* harmony import */ var _routes_users__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ./routes/users */ "./src/routes/users.js"
        );
        /* harmony import */ var _routes_auth__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! ./routes/auth */ "./src/routes/auth.js"
        );
        /* harmony import */ var _routes_profile__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
          /*! ./routes/profile */ "./src/routes/profile.js"
        );
        /* harmony import */ var _routes_posts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
          /*! ./routes/posts */ "./src/routes/posts.js"
        );
        ...
        app.use(
          "/api/users",
          _routes_users__WEBPACK_IMPORTED_MODULE_5__["default"]
        ); // auth Routes

        app.use(
          "/api/auth",
          _routes_auth__WEBPACK_IMPORTED_MODULE_6__["default"]
        ); // profile Routes

        app.use(
          "/api/profile",
          _routes_profile__WEBPACK_IMPORTED_MODULE_7__["default"]
        ); // posts Routes

        app.use(
          "/api/posts",
          _routes_posts__WEBPACK_IMPORTED_MODULE_8__["default"]
        ); // If that above routes didnt work, we 404 them and forward to error handler

        app.use(
          _handlers_errorHandler__WEBPACK_IMPORTED_MODULE_4__["notFound"]
        ); // Otherwise this was a really bad error we didn't expect! Shoot eh

        if (app.get("env") === "development") {
          /* Development Error Handler - Prints stack trace */
          app.use(
            _handlers_errorHandler__WEBPACK_IMPORTED_MODULE_4__[
              "developmentErrors"
            ]
          );
        }
...
*/
  ...
  */
    ...
    /***/ "./src/helpers/express-validator.js":
      /*!******************************************!*\
  !*** ./src/helpers/express-validator.js ***!
  \******************************************/
  ...
  \**********************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        _app__WEBPACK_IMPORTED_MODULE_1__["default"].set("port", PORT || 7777);
        var server = _app__WEBPACK_IMPORTED_MODULE_1__["default"].listen(
  ...
  \*****************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        var _require = __webpack_require__(
          ...
          check = _require.check; // controllers

        var _require2 = __webpack_require__(
            /*! ../controllers/userController */ "./src/controllers/userController.js"
          ),
          register = _require2.register; // validators

        var _require3 = __webpack_require__(
            /*! ../helpers/express-validator */ "./src/helpers/express-validator.js"
          ),
          registerValidator = _require3.registerValidator; // @route  POST api/users
        // @desc   Register User
        // @access Public
